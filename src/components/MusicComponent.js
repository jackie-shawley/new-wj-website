...
export default function MusicPage(props) {
    return(
        <React.Fragment>
            ...
            {/* Walt - Home player plus download plus photo */}
            {/* <Row style={{ marginTop: 25 }}>
                <Container fluid className='d-flex justify-content-around'>
                    ...
                    <Col xs={12} md={6} className='home-player'> */}
                        ...
                        {/* <iframe width="100%" height="150" frameborder="yes" allow="autoplay" download='true' title='Home player' src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/1683818547&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true"></iframe>
                ...
                <Container fluid className='d-flex justify-content-around'>
                    <Row>
                        ...
                        <Col xs={12} md={4}>
                           ...
                           {/* <Card>
                           <h3><a href='/Jackie'>Listen to Jackie's Music</a></h3>
